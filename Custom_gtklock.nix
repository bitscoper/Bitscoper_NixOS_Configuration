# https://github.com/NixOS/nixpkgs/blob/nixos-unstable/pkgs/by-name/gt/gtklock/package.nix
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = pkgs.fetchFromGitHub {
    owner = "bitscoper";
    repo = "Custom_gtklock";
    rev = "d6e5a1ceb301afabc9104b36a994269307d97195";
    hash = "sha256-+zhJlYPqFsGmbsGUtfLxA3fGMadVM0itUjOdNPPXw3s=";
  };
